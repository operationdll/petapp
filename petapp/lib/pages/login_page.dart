...
class _LoginPageState extends State<LoginPage> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 30.0),
                      _buildPasswordTF,
                      _buildForgotPasswordBnt(),
                      _buildRemeberMeCheckBox(),
                      _buildLoginBnt(),
  ...
  Widget _buildSignUpBtn() {
    return GestureDetector(
      onTap: () => print('Sign Up Button Predded'),
      child: RichText(
        text: TextSpan(
          children: [
            TextSpan(
  ...
  Widget _buildRemeberMeCheckBox() {
    return Container(
      height: 20.0,
      child: Row(
        children: <Widget>[
  ...
  Widget _buildForgotPasswordBnt() {
    return Container(
